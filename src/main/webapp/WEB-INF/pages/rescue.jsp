        ...
        <div class="rescue-form">
            ...
            <form id="rescueForm" method="POST" action="${pageContext.request.contextPath}/rescue">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="${param.reporterName}" required>
                </div>
                <div class="form-group">
                    <label for="contactNumber">Your Contact Number:</label>
                    <input type="tel" id="contactNumber" name="contactNumber" value="${param.reporterContact}" required>
                </div>
                <div class="form-group">
                    <label for="typeOfAnimal">Type of Animal:</label>
                    <select id="typeOfAnimal" name="typeOfAnimal" required>
                ...
                <div class="form-group">
                    <label for="descriptionOfInjury">Description of Injury:</label>
                    <textarea id="descriptionOfInjury" name="descriptionOfInjury" rows="4" required>${param.injuryDescription}</textarea>
                </div>
                <div class="form-group">
